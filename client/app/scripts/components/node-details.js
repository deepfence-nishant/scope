...
class NodeDetails extends React.Component {
      ...
      <div className="node-details">
        ...
        <div className="node-details-content">
          <p className="node-details-content-info">
            <strong>{this.props.label}</strong> is not actively doing network activity.
          </p>
        </div>
  ...
  renderDetails() {
    ...
    const tools = this.renderTools();
    const nodeName = details.label;
    const topologyType = topologyId;
    const styles = {
      controls: {
      ...
      <div className="node-details">
        ...
        <div className="node-details-content">
          {details.metrics && <div className="node-details-content-section">
            <div className="node-details-content-section-header">Availability</div>
            <NodeDetailsHealth
          ...
          {details.metadata && <div className="node-details-content-section">
            ...
            <DonutView nodeName={nodeName} topologyType={topologyType} />
