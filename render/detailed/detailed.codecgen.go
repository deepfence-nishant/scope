...
const (
	// ----- content types ----
	codecSelferC_UTF82351 = 1
	codecSelferC_RAW2351  = 0
	// ----- value types used ----
	codecSelferValueTypeArray2351 = 10
	codecSelferValueTypeMap2351   = 9
	// ----- containerStateValues ----
	codecSelfer_containerMapKey2351    = 2
	codecSelfer_containerMapValue2351  = 3
	codecSelfer_containerMapEnd2351    = 4
	codecSelfer_containerArrayElem2351 = 6
	codecSelfer_containerArrayEnd2351  = 7
)

var (
	codecSelferBitsize2351                         = uint8(reflect.TypeOf(uint(0)).Bits())
	codecSelferOnlyMapOrArrayEncodeToStructErr2351 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelferUnsafeString2351 struct {
	Data uintptr
	Len  int
}

type codecSelfer2351 struct{}
...
func (x *NodeSummaryGroup) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayElem2351)
				yym4 := z.EncBinary()
				_ = yym4
				if false {
				} else {
					r.EncodeString(codecSelferC_UTF82351, string(x.ID))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("id"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				yym5 := z.EncBinary()
				_ = yym5
				if false {
				} else {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF82351, string(x.Label))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("label"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				yym8 := z.EncBinary()
				_ = yym8
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("nodes"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				if x.Nodes == nil {
					r.EncodeNil()
				} else {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF82351, string(x.TopologyID))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("topologyId"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				yym14 := z.EncBinary()
				_ = yym14
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("columns"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				if x.Columns == nil {
					r.EncodeNil()
				} else {
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayEnd2351)
			} else {
				z.EncSendContainerState(codecSelfer_containerMapEnd2351)
			}
		}
	}
}
...
func (x *NodeSummaryGroup) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if false {
		...
		if yyct2 == codecSelferValueTypeMap2351 {
			yyl2 := r.ReadMapStart()
			if yyl2 == 0 {
				z.DecSendContainerState(codecSelfer_containerMapEnd2351)
			} else {
				x.codecDecodeSelfFromMap(yyl2, d)
			}
		} else if yyct2 == codecSelferValueTypeArray2351 {
			yyl2 := r.ReadArrayStart()
			if yyl2 == 0 {
				z.DecSendContainerState(codecSelfer_containerArrayEnd2351)
			} else {
				x.codecDecodeSelfFromArray(yyl2, d)
			}
		} else {
			panic(codecSelferOnlyMapOrArrayEncodeToStructErr2351)
		}
	}
}
...
func (x *NodeSummaryGroup) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		z.DecSendContainerState(codecSelfer_containerMapKey2351)
		yys3Slc = r.DecodeBytes(yys3Slc, true, true)
		yys3SlcHdr := codecSelferUnsafeString2351{uintptr(unsafe.Pointer(&yys3Slc[0])), len(yys3Slc)}
		yys3 := *(*string)(unsafe.Pointer(&yys3SlcHdr))
		z.DecSendContainerState(codecSelfer_containerMapValue2351)
		switch yys3 {
		case "id":
			if r.TryDecodeAsNil() {
				x.ID = ""
...
func (x *NodeSummaryGroup) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	z.DecSendContainerState(codecSelfer_containerArrayElem2351)
	if r.TryDecodeAsNil() {
		x.ID = ""
	} else {
		yyv15 := &x.ID
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("defaultSort"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				yym11 := z.EncBinary()
				_ = yym11
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF82351, string(x.Datatype))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("dataType"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				yym14 := z.EncBinary()
				_ = yym14
				if false {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF82351, string(x.LabelMinor))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("labelMinor"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				yym11 := z.EncBinary()
				_ = yym11
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF82351, string(x.Rank))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("rank"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				yym14 := z.EncBinary()
				_ = yym14
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF82351, string(x.Shape))
					}
				} else {
					r.EncodeString(codecSelferC_UTF82351, "")
				}
			} else {
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey2351)
					r.EncodeString(codecSelferC_UTF82351, string("shape"))
					z.EncSendContainerState(codecSelfer_containerMapValue2351)
					yym17 := z.EncBinary()
					_ = yym17
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[5] {
					z.EncSendContainerState(codecSelfer_containerMapKey2351)
					r.EncodeString(codecSelferC_UTF82351, string("stack"))
					z.EncSendContainerState(codecSelfer_containerMapValue2351)
					yym20 := z.EncBinary()
					_ = yym20
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					z.EncSendContainerState(codecSelfer_containerMapKey2351)
					r.EncodeString(codecSelferC_UTF82351, string("linkable"))
					z.EncSendContainerState(codecSelfer_containerMapValue2351)
					yym23 := z.EncBinary()
					_ = yym23
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[7] {
					z.EncSendContainerState(codecSelfer_containerMapKey2351)
					r.EncodeString(codecSelferC_UTF82351, string("pseudo"))
					z.EncSendContainerState(codecSelfer_containerMapValue2351)
					yym26 := z.EncBinary()
					_ = yym26
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[8] {
					z.EncSendContainerState(codecSelfer_containerMapKey2351)
					r.EncodeString(codecSelferC_UTF82351, string("metadata"))
					z.EncSendContainerState(codecSelfer_containerMapValue2351)
					if x.Metadata == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[9] {
					z.EncSendContainerState(codecSelfer_containerMapKey2351)
					r.EncodeString(codecSelferC_UTF82351, string("parents"))
					z.EncSendContainerState(codecSelfer_containerMapValue2351)
					if x.Parents == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[10] {
					z.EncSendContainerState(codecSelfer_containerMapKey2351)
					r.EncodeString(codecSelferC_UTF82351, string("metrics"))
					z.EncSendContainerState(codecSelfer_containerMapValue2351)
					if x.Metrics == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[11] {
					z.EncSendContainerState(codecSelfer_containerMapKey2351)
					r.EncodeString(codecSelferC_UTF82351, string("tables"))
					z.EncSendContainerState(codecSelfer_containerMapValue2351)
					if x.Tables == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[12] {
					z.EncSendContainerState(codecSelfer_containerMapKey2351)
					r.EncodeString(codecSelferC_UTF82351, string("adjacency"))
					z.EncSendContainerState(codecSelfer_containerMapValue2351)
					if x.Adjacency == nil {
						r.EncodeNil()
					} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("add"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				if x.Add == nil {
					r.EncodeNil()
				} else {
			...
			if yyr2 || yy2arr2 {
				...
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("update"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				if x.Update == nil {
					r.EncodeNil()
				} else {
			...
			if yyr2 || yy2arr2 {
				...
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("remove"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				if x.Remove == nil {
					r.EncodeNil()
				} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey2351)
					r.EncodeString(codecSelferC_UTF82351, string("reset"))
					z.EncSendContainerState(codecSelfer_containerMapValue2351)
					yym14 := z.EncBinary()
					_ = yym14
					if false {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("controls"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				if x.Controls == nil {
					r.EncodeNil()
				} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[14] {
					z.EncSendContainerState(codecSelfer_containerMapKey2351)
					r.EncodeString(codecSelferC_UTF82351, string("children"))
					z.EncSendContainerState(codecSelfer_containerMapValue2351)
					if x.Children == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[15] {
					z.EncSendContainerState(codecSelfer_containerMapKey2351)
					r.EncodeString(codecSelferC_UTF82351, string("connections"))
					z.EncSendContainerState(codecSelfer_containerMapValue2351)
					if x.Connections == nil {
						r.EncodeNil()
					} else {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF82351, string(x.ProbeID))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("probeId"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				yym5 := z.EncBinary()
				_ = yym5
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF82351, string(x.NodeID))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("nodeId"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				yym8 := z.EncBinary()
				_ = yym8
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF82351, string(x.Human))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("human"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				yym14 := z.EncBinary()
				_ = yym14
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF82351, string(x.Icon))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey2351)
				r.EncodeString(codecSelferC_UTF82351, string("icon"))
				z.EncSendContainerState(codecSelfer_containerMapValue2351)
				yym17 := z.EncBinary()
				_ = yym17
				if false {
		...
		case "rank":
			if r.TryDecodeAsNil() {
				...
				if false {
					...
					*((*int)(yyv14)) = int(r.DecodeInt(codecSelferBitsize2351))
				}
			}
		default:
			z.DecStructFieldNotFound(-1, yys3)
...
func (x *wiredControlInstance) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	if r.TryDecodeAsNil() {
		...
		if false {
			...
			*((*int)(yyv27)) = int(r.DecodeInt(codecSelferBitsize2351))
		}
	}
	for {
		yyj16++
...
func (x codecSelfer2351) encSliceNodeSummary(v []NodeSummary, e *codec1978.Encoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
...
func (x codecSelfer2351) decSliceNodeSummary(v *[]NodeSummary, d *codec1978.Decoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer2351) encSliceColumn(v []Column, e *codec1978.Encoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer2351) decSliceColumn(v *[]Column, d *codec1978.Decoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer2351) encSlicereport_MetadataRow(v []pkg1_report.MetadataRow, e *codec1978.Encoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer2351) decSlicereport_MetadataRow(v *[]pkg1_report.MetadataRow, d *codec1978.Decoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer2351) encSliceParent(v []Parent, e *codec1978.Encoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer2351) decSliceParent(v *[]Parent, d *codec1978.Decoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer2351) encSlicereport_MetricRow(v []pkg1_report.MetricRow, e *codec1978.Encoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer2351) decSlicereport_MetricRow(v *[]pkg1_report.MetricRow, d *codec1978.Decoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer2351) encSlicereport_Table(v []pkg1_report.Table, e *codec1978.Encoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer2351) decSlicereport_Table(v *[]pkg1_report.Table, d *codec1978.Decoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer2351) encnodeSummariesByID(v nodeSummariesByID, e *codec1978.Encoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer2351) decnodeSummariesByID(v *nodeSummariesByID, d *codec1978.Decoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer2351) encNodeSummaries(v NodeSummaries, e *codec1978.Encoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	...
	for yyk1, yyv1 := range v {
		...
		if false {
			...
			r.EncodeString(codecSelferC_UTF82351, string(yyk1))
		}
		z.EncSendContainerState(codecSelfer_containerMapValue2351)
		yy3 := &yyv1
...
func (x codecSelfer2351) decNodeSummaries(v *NodeSummaries, d *codec1978.Decoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer2351) encSliceControlInstance(v []ControlInstance, e *codec1978.Encoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer2351) decSliceControlInstance(v *[]ControlInstance, d *codec1978.Decoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer2351) encSliceNodeSummaryGroup(v []NodeSummaryGroup, e *codec1978.Encoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer2351) decSliceNodeSummaryGroup(v *[]NodeSummaryGroup, d *codec1978.Decoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer2351) encSliceConnectionsSummary(v []ConnectionsSummary, e *codec1978.Encoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer2351) decSliceConnectionsSummary(v *[]ConnectionsSummary, d *codec1978.Decoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer2351) encSliceConnection(v []Connection, e *codec1978.Encoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer2351) decSliceConnection(v *[]Connection, d *codec1978.Decoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer2351) encconnectionsByID(v connectionsByID, e *codec1978.Encoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer2351) decconnectionsByID(v *connectionsByID, d *codec1978.Decoder) {
	var h codecSelfer2351
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
